...
%desc = (
	"axili2ccpu"	=> "I2C CPU, Controlled via AXI-Lite",
	"axisi2c"	=> "I2C CPU, Internal stream based component",
	"wbi2ccpu"	=> "I2C CPU, Controlled via Wishbone"
	);
## }}}
...
<BODY>
<H1 align=center>WBI2C Verification Report</H1>
